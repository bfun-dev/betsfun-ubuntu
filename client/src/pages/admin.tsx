...
import { Users, TrendingUp, Wallet, DollarSign, Shield, Target, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-2 sm:p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 mb-4 md:mb-8">
            ...
            <TabsTrigger value="subscriptions" className="flex items-center gap-1 md:gap-2 text-xs md:text-sm">
