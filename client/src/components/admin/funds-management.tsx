...
function AdminWallets() {
  ...
  const calculateTotalBalance = () => {
    ...
    // SOL balance (already in SOL units, not lamports)
    if (adminWallets.solana?.balance) {
      const solAmount = parseFloat(adminWallets.solana.balance);
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold">
                  {formatBalance(adminWallets.solana.balance, 0)} SOL
                </div>
                <div className="text-sm text-muted-foreground">
                  {calculateUSDValue(adminWallets.solana.balance, "SOL", 0)}
                </div>
              </div>
            </div>
          </CardHeader>
