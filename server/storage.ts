...
export interface IStorage {
  ...
  purchaseSubscription(userId: string, planId: string, price: string): Promise<UserSubscription>;
...
export class DatabaseStorage implements IStorage {
  ...
  // Subscription operations
  async purchaseSubscription(userId: string, planId: string, price: string): Promise<UserSubscription> {
